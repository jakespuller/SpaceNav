...
extern "C"
{
	...
	extern gpointer*	mono_aot_module_ES2_info; // ES2.dll
	extern gpointer*	mono_aot_module_EasyRoads3D_info; // EasyRoads3D.dll
	extern gpointer*	mono_aot_module_Elixis_info; // Elixis.dll
...
void RegisterMonoModules()
{
	...
	mono_aot_register_module(mono_aot_module_ES2_info);
	mono_aot_register_module(mono_aot_module_EasyRoads3D_info);
	mono_aot_register_module(mono_aot_module_Elixis_info);
